            ...
            <div class="pcoded-inner-content">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Latest Projects</h5>
                                        </div>
                                        <ul class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="index.php"><i
                                                        class="feather icon-home"></i></a></li>
                                            <li class="breadcrumb-item"><a href="#!">Latest Projects</a></li>
                                        </ul>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="card-header-right">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title"> Create Latest Projects</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="post"
                                                                action="{{route('Latest_ProjectsSubmit')}}"
                                            ...
                                            {{-- Edite  Latest Projects SECATION --}}


                                            <div class="modal fade" id="EditLatestProjects" tabindex="-1" role="dialog"
                                                aria-labelledby="EditLatestProjects" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">Edit Latest Projects</h5>
                                                            <button type="button" class="close" data-dismiss="modal"
                                                                aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        ...
                                                        <div class="modal-body">
                                                            <form class="edit-form"
                                                                action="{{route('UpdateLatest_Projects')}}"
                ...
                <div class="card-body">
                    ...
                    <table id="demo-foo-filtering" class="table table-striped table-hover">
                        ...
                        <tbody>
                            <!--Start Table Row-->
                            @foreach($project as $old_project)
                            <tr class="data-row">
                                <td hidden></td>
                                <td>{{ ++$i }}</td>
                                <td class="title">{{$old_project->title}}</td>
                                <td class="desc">{{$old_project->desc}}</td>
                                <td class="image">{{$old_project->image}}</td>
                                <td>
                                    <form action="{{ route('deleteLatest_Projects', $old_project->id) }}" method="POST">
                                        <button class="btn btn-success btn-sm btnEditLatestProjects" type="button"
                                            data-toggle="modal" data-item-id="{{$old_project->id}}"
                                            data-target="#EditLatestProjects">Edit
...
<script>
    ...
    $('.btnEditLatestProjects').on('click', function() {
          $(this).addClass('edit-item-trigger-clicked'); //useful for identifying which trigger was clicked and consequently grab data from the correct row and not the wrong one.
});

    $('#EditLatestProjects').on('show.bs.modal', function() {
  ...
  $('#EditLatestProjects').on('hide.bs.modal', function() {
