            ...
            <div class="pcoded-inner-content">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Project Items</h5>
                                        </div>
                                        <ul class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="index.php"><i
                                                        class="feather icon-home"></i></a></li>
                                            <li class="breadcrumb-item"><a href="#!">Project Items</a></li>
                                        </ul>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="card-header-right">
                                            <!--Start Create Project Items-->
                                            <button class="btn btn-success btn-sm" type="button" data-toggle="modal"
                                                data-target="#CreateProjectItems">
                                                <i class="fa fa-plus">Add</i>
                                            </button>
                                            <!-- Modal -->
                                            <div class="modal fade " id="CreateProjectItems" tabindex="-1" role="dialog"
                                                aria-labelledby="CreateProjectItems" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title"> Create Project Items</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="post"
                                                                action="{{route('Project_ItemsSubmit')}}"
                                            ...
                                            {{-- Edite  Project items SECATION --}}


                                            <div class="modal fade" id="EditProjectItems" tabindex="-1" role="dialog"
                                                aria-labelledby="EditProjectItems" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">Edit Project Items</h5>
                                                            <button type="button" class="close" data-dismiss="modal"
                                                                aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        ...
                                                        <div class="modal-body">
                                                            <form class="edit-form"
                                                                action="{{route('UpdateProject_items')}}" method="POST"
                                                                enctype="multipart/form-data">
                                                                <!--Start Row-->
                                                                @csrf
                                                                @method('PUT')
                ...
                <div class="card-body">
                    ...
                    <table id="demo-foo-filtering" class="table table-striped table-hover">
                        ...
                        <tbody>
                            <!--Start Table Row-->
                            @foreach($ProjectItem as $project_item)
                            <tr class="data-row">
                                <td hidden></td>
                                <td>{{ ++$i }}</td>
                                <td class="title">{{$project_item->title}}</td>
                                <td class="desc">{{$project_item->desc}}</td>
                                <td class="image">{{$project_item->image}}</td>

                                <td>
                                    <form action="{{ route('deleteProject_items', $project_item->id) }}" method="POST"
                                        enctype="multipart/form-data">
                                        <button class="btn btn-success btn-sm btnEditProjectItems" type="button"
                                            data-toggle="modal" data-item-id="{{$project_item->id}}"
                                            data-target="#EditProjectItems">Edit
...
<script>
    ...
    $('.btnEditProjectItems').on('click', function() {
          $(this).addClass('edit-item-trigger-clicked'); //useful for identifying which trigger was clicked and consequently grab data from the correct row and not the wrong one.
});

    $('#EditProjectItems').on('show.bs.modal', function() {
  ...
  $('#EditProjectItems').on('hide.bs.modal', function() {
